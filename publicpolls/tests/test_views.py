...
class ViewWikiTests(unittest.TestCase):
    ...
    def _callFUT(self, request):
        from publicpolls.views.default import view_wiki
...
class ViewPageTests(BaseTest):
    def _callFUT(self, request):
        from publicpolls.views.default import view_page
...
class AddPageTests(BaseTest):
    def _callFUT(self, request):
        from publicpolls.views.default import add_page
...
class EditPageTests(BaseTest):
    def _callFUT(self, request):
        from publicpolls.views.default import edit_page
